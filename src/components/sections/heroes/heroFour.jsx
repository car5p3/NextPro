            ...
            <div className='bg-[rgba(226,231,255,0.4)] dark:bg-[#1c232a] rounded-[30px] lg:pl-[52px] lg:pr-0 pl-4 pr-4 border-2 border-[rgba(0,31,63,0.05)] overflow-y-hidden overflow-x-hidden'>
                <div className='grid lg:grid-cols-2 grid-cols-1'>
                    ...
                    <div className='lg:pt-[132px] lg:pb-[120px] pt-12 pb-12'>
                        ...
                        <h1 className="text-6xl text-[#001F3F] font-bold">Web Founders USA - No.1 Digital Marketing Agency in USA</h1>
                        <p className='font-semibold max-w-[689px] pt-7.5'>Brands lose customers every day to slow websites, weak visibility, and outdated design. Web Founders USA, a trusted Website Design and Development Company and full-service top Digital Marketing Agencies in USA, rebuilds that momentum with powerful solutions. </p>
