export const blogData = [
  {
    slug: "why-businesses-struggle-with-seo-in-2026",
    hero: {
    ...
    sections: {
      ...
      aiAndTechnical: {
        left: {
          ...
          focusTitle: "This is why modern professional seo services focus on:",
          focusItems: [
      ...
      diy: {
        ...
        fix: "Professional help avoids these mistakes and creates a system that improves rankings over time.",
      },
      diagnosis: {
  ...
  {
    slug: "the-biggest-social-media-marketing-mistakes-in-2026",
    hero: {
      badge: "Industry Insight 2026",
      title:
        "The Biggest Social Media Marketing Mistakes in 2026",
      subtitle: "Social media marketing in 2026 is not the same as it was two years ago.",
      image: {
        src: "/blogs/blog-4-1.webp",
    ...
    intro: {
      lead: "The platforms changed",
      paragraphs: [
        "The audience changed.",
        "The competition grew fast.",
      ],
      highlightCards: [
        { title: "More", text: "Businesses are online" },
        { title: "More", text: "Websites are competing" },
